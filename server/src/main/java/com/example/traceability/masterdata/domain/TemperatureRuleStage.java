 ...
 * 冷链温控规则环节明细实体。
 * <p>
 * 映射数据库 {@code temperature_rule_stage} 表。
 * 定义加工、仓储、运输、零售等环节的温控上下限阈值与缓冲时间。
 * </p>
 *
 * @author Seafood Traceability Team
 * @since 0.1.0
 */
@TableName("temperature_rule_stage")
public class TemperatureRuleStage {
    ...
    @TableField("allowed_duration_seconds")
